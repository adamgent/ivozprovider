...
class Cgrates
{
    ...
    public function reload()
    {
        try {
            ...
            $this->logger->info(
                sprintf(
                    "ApierV1.LoadTariffPlanFromStorDb GEARMAN Reloading Tpid %s through CGRateS API",
                    $cgratesTpid
                )
            );
            ...
            $this->logger->info(
                sprintf(
                    "ApierV1.LoadTariffPlanFromStorDb GEARMAN Reloaded Tpid %s through CGRateS API",
                    $cgratesTpid
                )
            );
        } catch (\Exception $e) {
